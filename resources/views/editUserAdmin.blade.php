	...
	<div class="container">
		<main class="form-signin">
			<form action="" method="post">
				...
				<div class="form-floating">
					<input type="text" class="form-control" class="@error('home_address_id') is-invalid @enderror"
						id="home_address_id" name="home_address_id" placeholder="name@example.com">
				...
				<div class="form-floating">
					<input type="text" class="form-control" class="@error('balance') is-invalid @enderror" id="balance"
						name="balance" placeholder="name@example.com">
					<label for="floatingUsername">Balance</label>
				</div>
				@error('balance')
				<div class="alert alert-danger">{{ $message }}</div>
				@enderror
				...
				<div class="form-floating">
					<input type="text" class="form-control" class="@error('birthday') is-invalid @enderror"
						id="birthday" name="birthday" placeholder="name@example.com">
				...
				<div class="form-floating">
					<input type="text" class="form-control" class="@error('currency_id') is-invalid @enderror"
						id="currency_id" name="currency_id" placeholder="name@example.com">
