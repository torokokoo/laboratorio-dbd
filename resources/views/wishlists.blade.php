...
<body>
  ...
  <section>
    ...
    <a href="/wishlist/create/{{$_COOKIE['id']}}"><button type="button" class="btn btn-success">Nueva lista de
        deseos</button></a>
      ...
      <table class="table table-dark table-striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a class="btn btn-outline-warning" href="/wishlist/{{$wishlist->id}}" role="button">Ver más
                información</a>
